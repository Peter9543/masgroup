...
import rasgas from '@/assets/logos/rasgas.png'
import  Dohacity from '@/assets/logos/Dohacity.png'
import  fifalogo from '@/assets/logos/fifalogo.jpg'
import qatartairways from '@/assets/logos/qatartairways.jpg'
...
const Home = () => {
    ...
    return (
        <div className="pt-16"> {/* Added padding top to account for fixed header */}
            {/* Hero Section */}
            <section className="relative  text-white py-20 transition-colors h-screen ">
                ...
                <div className="container mx-auto px-4 text-center relative z-10">
                    ...
                    <Button className="bg-white text-blue-900 hover:bg-gray-100 font-bold py-3 px-8 text-lg dark:bg-gray-200 dark:hover:bg-gray-300">
            ...
            {/* Core Services */}
            <section className="py-16 bg-gray-50 dark:bg-gray-800 transition-colors duration-300 p-10">
                <div className=" mx-auto px-4">
                    <h2 className="text-3xl font-bold text-center mb-12 text-gray-900 dark:text-white">Our Core Services</h2>
            ...
            <section className="py-16 dark:bg-gray-900 transition-colors duration-300" ref={statsRef}>
                <div className="container mx-auto px-4">
                    <h2 className="text-3xl font-bold text-center mb-12 text-gray-900 dark:text-white">Why Choose MAS Group?</h2>
            ...
            <section className="py-16 bg-gray-50 dark:bg-gray-800 transition-colors duration-300 container mx-auto">
                <div className=" px-4">
                    ...
                    >
                        {clientLogos.map((logo) => (
                            <div
                                key={logo.id}
                                className="flex items-center justify-center bg-white dark:bg-gray-700 p-6 rounded-lg shadow-sm w-48 h-43 dark:shadow-gray-700 mx-6"
                            >
            ...
            <section className="py-16 dark:bg-gray-900 transition-colors duration-300">
                <div className="container mx-auto px-4">
                    <h2 className="text-3xl font-bold text-center mb-12 text-gray-900 dark:text-white">Global Presence</h2>
            ...
            <section className="py-16 bg-blue-900 dark:bg-blue-800 text-white transition-colors duration-300">
                <div className="container mx-auto px-4 text-center">
                    ...
                    <Button className="bg-white text-blue-900 hover:bg-gray-100 font-bold py-3 px-8 text-lg dark:bg-gray-200 dark:hover:bg-gray-300 dark:text-blue-900">
                        Get a Quote Today
                    </Button>
                </div>
            </section>
