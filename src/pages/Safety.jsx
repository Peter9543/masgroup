    ...
    <div className="pt-16 dark:bg-gray-900 transition-colors duration-300">
      <div className="container mx-auto px-4 py-12">
        <div className="text-center mb-16">
          <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">Safety</h1>
        ...
        <section className="mb-16">
          <div className="bg-gradient-to-r from-blue-900 to-blue-700 dark:from-blue-800 dark:to-blue-600 rounded-lg p-8 text-white text-center">
        ...
        {/* Our Approach */}
        <section className="mb-16">
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-8 text-center">Our Safety Approach</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md dark:shadow-gray-700">
              <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Integrated Safety Planning</h3>
            ...
            <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md dark:shadow-gray-700">
              <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">On-Site Safety Supervision</h3>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
        ...
        {/* Compliance */}
        <section className="mb-16">
          <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-8 dark:shadow-gray-700">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-6 text-center">Regulatory Compliance</h2>
            <div className="max-w-3xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="text-center">
                  ...
                  <p className="text-gray-600 dark:text-gray-300">ISO certifications and quality management systems</p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Health & Safety</h3>
                  <p className="text-gray-600 dark:text-gray-300">Comprehensive health and safety protocols</p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <p className="text-gray-600 dark:text-gray-300">Environmental protection and sustainability</p>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* Safety Culture */}
        <section>
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-8 text-center">Building a Safety Culture</h2>
          <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md dark:shadow-gray-700">
            <p className="text-gray-700 dark:text-gray-300 text-lg mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4">Training & Education</h3>
                <ul className="space-y-2">
                  <li className="flex items-start">
                    <svg className="w-5 h-5 text-blue-600 dark:text-blue-400 mr-2 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
