    ...
    <footer className="bg-gray-200 text-gray-900 pt-3 transition-colors duration-300 border-t-2 border-yellow-500">
      <div className="w-full px-4">
        <div className="grid grid-cols-2 md:grid-cols-4  gap-6 ">
          ...
          {/* UAE Office */}
          <div>
            <h3 className="text-lg font-semibold mb-3 text-yellow-600">UAE Office</h3>
          ...
          {/* Qatar Office */}
          <div>
            <h3 className="text-lg font-semibold mb-3 text-yellow-600">Qatar Office</h3>
            <address className="not-italic text-gray-700 text-sm">
          ...
          {/* KSA Office */}
          <div>
            <h3 className="text-lg font-semibold mb-3 text-yellow-600">KSA Office</h3>
            <address className="not-italic text-gray-700 text-sm">
